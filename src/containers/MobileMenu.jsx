...
import { SearchComponent, MobileMenuItem } from "../components/index";
...
const MobileMenu = ({ genres, categories, selected }) => {
  ...
  return (
    <React.Fragment>
      ...
      <Menu isOpen={isOpened} onStateChange={isMenuOpen} styles={styles}>
        ...
        {renderCategory(categories, selected, setisOpened)}
...
function renderCategory(categories, selected, setisOpened) {
